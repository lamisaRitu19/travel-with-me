...
const GuideMe = () => {
    ...
    return (
        <Container fluid className='my-5 pb-5 pt-5'>
            <Row className='mt-5 mb-5 padding-bottom'>
                <Col xs={12} md={6} className='d-flex justify-content-center justify-content-md-end align-items-center align-items-lg-end'>
                    <img src={imgBg} alt="" className='position-home shadow-blue' />
                    <img src={imgGirl} alt="" className='img-height-home shadow-lg mb-3 mb-md-0' />
                </Col>
